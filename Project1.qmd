...
plot_state(wrapper_result$non_county_data, var_name = "enrollment")
...
plot_county <- function(data, state2 = "NC", var_name = "enrollment", top_bottom_county = "top", num_of_county = 5) {
  ...
  #           else(top_bottom_county == "bottom") desc(mean_value, FALSE)
...
plot_county(wrapper_result$county_data,state = "NC", var_name = "enrollment", top_bottom_county = "top", num_of_county = 5)
