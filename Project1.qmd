...
#function for steps 1 and 2
  ...
  step_3 <- function(data) {
    data |>
      mutate(data, year = as.numeric(substr(measurement_year, nchar(measurement_year) - 2, nchar(measurement_year))), measurement = substr(measurement_year, 1, nchar(measurement_year) - 3)
      )
  }
